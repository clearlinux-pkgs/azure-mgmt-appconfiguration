...
Source0  : https://files.pythonhosted.org/packages/dd/b1/da10dc4bbe2af67cc71f7031af6c102516227a8cf03ac1e503a6ba0e9194/azure-mgmt-appconfiguration-1.0.1.zip
...
%prep
%setup -q -n azure-mgmt-appconfiguration-1.0.1
cd %{_builddir}/azure-mgmt-appconfiguration-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608045441
